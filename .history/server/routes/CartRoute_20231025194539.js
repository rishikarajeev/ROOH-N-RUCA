...
CartRoute.post("/addproduct",upload.single("image"), async(req, res) => {
  ...
  const product=await CartModel.findOne({ productid:productid,username :username});
 console.log(product);
...
CartRoute.delete("/deletefavouriteproduct/:id", (req, res) => {
...
//delete product
CartRoute.delete("/deletecartproduct/:id", (req, res) => {
  CartModel.deleteOne({
    _id: req.params.id,
  })
    .then(() => {
...
CartRoute.delete("/deleteallproducts/:username", (req, res) => {
