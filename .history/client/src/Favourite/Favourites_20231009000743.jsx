...
function Favourites() {
  ...
  const DeletefavouriteUrl = `${BASE_URL}/cart/deletefavouriteproduct/:i`;
  ...
  const toggleFavorite = (_id) => {
    ...
    if (itemIndex !== -1) {
      ...
      addtoFavourite(updatedFavourite[0]);
      }else
      {
                  ...
                  <div className="card-body">
                    <div className="row">
                      <div className="col-9 text-end ">
                        ...
                        <span className="fs-4 ms-3 text-start" onClick={()=>toggleFavorite(item._id)}>
