...
function Favourites() {
  ...
  const DeletefavouriteUrl = `${BASE_URL}/deletefavouriteproduct/:id/`;
  const FavouriteADDurl = `${BASE_URL}/caraddfavourites/`;
  const FavouritesUrl = `${BASE_URL}/cart/favouritedetails/`;
  ...
  useEffect(() => {
    axios.get(FavouritesUrl).then((response) => {
