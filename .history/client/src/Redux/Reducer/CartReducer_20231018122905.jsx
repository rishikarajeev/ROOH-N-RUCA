...
export const RemoveCartProducts = createAsyncThunk("cart/delete", async (_id) => {
  ...
  export const RemoveAllCartProducts = createAsyncThunk("cart/delete", async (_id) => {
    const data = await axios.delete(`${BASE_URL}/cart/export const RemoveCartProducts = createAsyncThunk("cart/delete", async (_id) => {
    const data = await axios.delete(`${BASE_URL}/cart/deletecartproduct/${_id}`);
    console.log(data);
