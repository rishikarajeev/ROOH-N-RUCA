    ...
    incrementProduct:(state,action)=>
             {
              state.viewCart= state.viewCart.map((item) => {
                    if(item._id === action.payload._id) {
                        ...
                        item.subTotal =  item.quantity *item.ptice;
                    }
                    return item;
                })
            },
       ...
       subTotal:(state,action)=>{
            state.viewCart= state.viewCart.map((item) => {
              if(item._id === action.payload._id) {
               ...
               item.subTotal=  action.payload.quantity *  action.payload.price;
              }
              return item;
          })
...
export const {incrementProduct,decrementProduct,subTotal}=cartSlice.actions;
