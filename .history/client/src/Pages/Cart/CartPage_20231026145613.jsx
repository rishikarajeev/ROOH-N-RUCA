...
//fetch cart items from reducer and calculate total price
  useEffect(() => {
    ...
    if (cartItems === undefined || cartItems.length === 0) {
      console.log('State is empty or undefined');
    } else {
      console.log('State has data:', cartItems);
      calculateTotal();
    }
  ...
  const handleIncrement = (itemId, item,event) => {
                        ...
                        <div className="row row-cols-3">
                          <div class=" d-md-flex text-center border border-dark p-2  row row-cols-3 ">
                            <button
                              ...
                              onClick={() =>
                                handleDecrement(item._id,item,event)
                              }
                            >
                              -
                            </button>
                            ...
                            <button
                              ...
                              onClick={() => handleIncrement(item._id, item,event)}
                            >
                              +
                            </button>
                          </div>
