...
function CartPage() {
  ...
  const handleIncrement = (qua) => {
    setCartData({ ...cartItems, quantity:qty + 1 });
  };

  const handleDecrement = (CartItem) => {
    if (CartItem.quantity > 0) {
      setCartData({ ...cartItems, quantity: CartItem.quantity - 1 });
    }
  };
                      ...
                      <div className="col-1 d-grid gap-2 d-md-flex justify-content-md-start ">
                        ...
                        <h5 className="card-title fw-bold ">
                          ...
                          <div class="d-grid gap-2 d-md-flex justify-content-md-start ">
                            <button onClick={() => handleIncrement(CartItem.quantity)}>
                              -
                            </button>
