                  ...
                  <div className="row ">
                    ...
                    <div className="col-sm-8">
                     ...
                     <div className="row row-cols-3">
                        <div class="gap-2 d-md-flex justify-content-md-start border border-dark p-2  row " style={{"max-width":"100px"}}>
                        <button className="col border border-white bg-white mx-auto fs-5 "  onClick={() => handleDecrement(item._id,item.quantity)}>
                          -
                        </button>
                        <span className="fs-5 col ">{item.quantity}</span>
                        <button className="col border border-white bg-white mx-auto fs-5"   onClick={() => handleIncrement(item._id)}>
                          +
                        </button>
                        </div>
                        <div>
