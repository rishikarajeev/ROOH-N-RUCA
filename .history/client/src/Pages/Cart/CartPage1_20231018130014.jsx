...
function CartPage() {
  ...
  const calculateTotalPrice = () => {
         return subTotal.reduce(function(accumulator, currentValue) {
  ...
  const handleDecrement = (productdata) => {
    ...
    const {quantity ,price}=productdata;
    if(quantity>1)
    setProductata({ ...productdata, quantity: quantity - 1,subtotal :calculateSubtotal(updatedCart[itemIndex]),totalcalculateTotalPrice();});
  ...
  return (
    <>
      <div className="container">
        <h5 className="fs-bold" >Shopping Cart</h5>
