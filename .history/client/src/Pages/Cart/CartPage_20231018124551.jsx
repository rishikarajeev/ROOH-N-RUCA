...
import { RemoveAllCartProducts, RemoveCartProducts, getCartProducts } from "../../Redux/Reducer/CartReducer";
  ...
  return (
    <>
      <div className="container  bg-white border border-light">
        <h2 className="cols-10">Shopping Cart</h2>
        <button className="btn btn-dark m-2  float-end"onClick={() => RemoveAllCart()}> <span className="text-right  ">Delete All  
                              <i className="fas fa-trash"></i>
                            </span> </button>
        <Button  className=" cols-1 float-right bg-dark " onClick={() => RemoveAllCart()}>
                            <span className="text-right  ">Delete All  
                              <i className="fas fa-trash"></i>
                            </span>
                          </Button>
