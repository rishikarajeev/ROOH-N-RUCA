...
function CartPage() {
  ...
  function calculateSubtotals(cart) {
    return cart.map(item => {
      // Calculate subtotal: quantity * price
      const subtotal = item.quantity * item.price;
  
      // Add 'subtotal' key to the item
                      ...
                      <div className="col-1 d-grid gap-2 d-md-flex justify-content-md-start ">
                        ...
                        <h5 className="card-title fw-bold ">
                          ...
                          <div class="d-grid gap-2 d-md-flex justify-content-md-start ">
                            <button onClick={(event) => handleIncrement(item.quantity,item._id,i)}>
                              -
                            </button>
