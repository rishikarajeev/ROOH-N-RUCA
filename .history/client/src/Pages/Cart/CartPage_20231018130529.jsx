...
function CartPage() {
  ...
  const handleIncrement = (productdata) => {
    ...
    if (itemIndex !== -1) {
    if(quantity>1)
    setProductata({ ...productdata, quantity: quantity + 1,subtotal :calculateSubtotal(productdata(itemIndex)),total:calculateTotalP()});
    calculateTotal();
    }
  ...
  const handleDecrement = (productdata) => {
    ...
    if (itemIndex !== -1) {
    if(quantity>1)
    setProductata({ ...productdata, quantity: quantity - 1,subtotal :calculateSubtotal(productdata(itemIndex)),total:calculateTotalPrice()});
    calculateTotal();
    }
