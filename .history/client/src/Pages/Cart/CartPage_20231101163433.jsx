      ...
      <div className="container  bg-white border border-light">
        <div className=" row row-cols-auto">
          ...
          <button
            ...
            onClick={() => dispatchRemoveAllCartProducts(username))}
          >
            {" "}
                    ...
                    <div className="row">
                      <div className="col-9 text-end ">
                        <div className="row row-cols-3">
                          ...
                          <div onClick={() =>  dispatch(RemoveCartProducts(item._id))}>
      ...
      :  <div>Cart is Empty</div>
        ...
        <div className="float-end m-2">
          <div className="">
            <strong>
              Estimated Total:
              <CurrencyDisplay amount={!cartItems?0:total} currencySymbol="AED" />
            </strong>
          </div>
          <Link to="/checkout ">
