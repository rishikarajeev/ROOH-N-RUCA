              ...
              <div className="row ">
                ...
                <div className="col-sm-8">
                  <div className="card-body">
                    <div className="row">
                      <div className="col-1 d-grid gap-2 d-md-flex justify-content-md-start "></div>
                      <div className="col-9 text-end">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-start ">
                          <button
                            onClick={(event) =>
                              handleIncrement(item.quantity, item._id, item)
                            }
                          >
                            -
                          </button>
                          ...
                          <button
                            onClick={(event) =>
                              handleIncrement(item.quantity, item._id)
                            }
                          >
                            +
                          </button>
