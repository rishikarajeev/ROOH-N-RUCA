...
function CartPage() {
  ...
  const handleIncrement = (quantity,itemId) => {
    ...
    if (itemIndex !== -1) {
      // Update the quantity
    const newQuantity= cartItems[itemIndex].quantity 
      setCartData({ ...cartItems,newQuantity});
                      ...
                      <div className="col-1 d-grid gap-2 d-md-flex justify-content-md-start ">
                        ...
                        <h5 className="card-title fw-bold ">
                          ...
                          <div class="d-grid gap-2 d-md-flex justify-content-md-start ">
                            <button onClick={() => handleIncrement(item.quantity,CartItem._id)}>
                              -
                            </button>
                            <span className="text-center">{item.quantity}</span>
                            <button onClick={() => handleIncrement(CartItem.quantity,CartItem._id)}>
                              +
                            </button>
