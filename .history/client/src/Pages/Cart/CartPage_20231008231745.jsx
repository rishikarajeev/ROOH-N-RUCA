...
function CartPage() {
  ...
  const ProductUrl = `${token}/cart/cartdetails`;
  console.log("token", usertoken);

  console.log("URL", `bearer-token ${token}`);
    ...
    <>
      ...
      <div className="container  bg-white border border-light">
        ...
        <div className="float-end m-2">
          <div className="">
            <strong>Estimated Total:<CurrencyDisplay amount={totalPrice} currencySymbol="AED" /></strong>
          </div>
          <Link to="/checkout ">
