      ...
      >
        ...
        <Form.Group className="mb-3">
          ...
          <DropdownButton
            ...
            onSelect={(event,e)=>this.handleSelect(event,e.target.value)}
       
            isInvalid={!!errors.category}
          >
            {category.map((item) => (
  
              <Dropdown.Item key={item.categoryname} onClick={() => setSelectedItem(item)} >{item.categoryname}</Dropdown.Item>
            ))}
          </DropdownButton>
