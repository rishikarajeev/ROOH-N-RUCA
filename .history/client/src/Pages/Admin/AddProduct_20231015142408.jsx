      ...
      >
        ...
        <Form.Group className="mb-3">
          ...
          <DropdownButton
           ...
           tit {selectedItem ? selectedItem.name : 'Select an Item'}
          ...
          >
            {category.map((item) => (
              ...
              <Dropdown.Item key={item.categoryname}  name="category" onClick={() => handleSelect(item.categoryname)} >{item.categoryname}</Dropdown.Item>
            ))}
          </DropdownButton>
