...
import { Button,  Form,Container,DropdownItem,Dropdown,DropdownButton } from "react-bootstrap";
...
function AddProduct() {
  ...
  return (
    <Container>
      <Header3 />
      <Form   validated={validated} onSubmit={SubmitProduct} className="m-5 needs-validation"
