...
function PruductDetailCartApi() {
  ...
  const product = useSelector((state) => state.cart.viewCart);
  ...
  const handleDecrement = () => {
    const { quantity, price } = productdata;
    if (quantity > 1) setProductata({ ...productdata, quantity: quantity - 1 });
  };
            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <div className=" justify-content-md-start m-3 ">
                  <div
                    class="gap-2 d-md-flex justify-content-md-start border border-dark p-2   "
