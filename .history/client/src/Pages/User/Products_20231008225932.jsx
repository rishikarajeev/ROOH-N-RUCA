...
function Products() {
  ...
  const RemovefavouriteUrl = `${BASE_URL}/favourite/deletefavouriteproduct/${username}`;
  ...
  const removeFavourite = (isFavorite, name) => {
    axios.delete(RemovefavouriteUrl).then((response) => {
      console.log(response.data);
