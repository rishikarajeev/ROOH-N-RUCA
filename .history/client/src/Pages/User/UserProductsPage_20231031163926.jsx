...
function Products({ searchTerm }) {
  ...
  const toggleFavorite = (_id, fav, name) => {
    ...
    addtoFavourite(updatedObject,_id);

  };

  const addtoFavourite = (isFavorite,_id) => {
    console.log(isFavorite.f);
    ...
    else
    {
        ...
        axios.delete(`${RemovefavouriteUrl}/${_id}`, isFavorite).then((response) => {
          console.log(response);
        });
