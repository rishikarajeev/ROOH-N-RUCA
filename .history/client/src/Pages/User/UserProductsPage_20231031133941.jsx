...
function Products({ searchTerm }) {
  ...
  //favourite set to false in usestate having productname,favourite and username 
...
//onclick change fav boolean value and call api to add the details
  const toggleFavorite = (_id, fav, name) => {
    console.log(fav);
    if (fav == false|| fav==nul) {
      fav = true;
    } else {
      fav = false;
    }
...
//api to add favourite or cahnge the boolean value
