            ...
            <div className="col-md-8">
              ...
              <h4 className="card-title fw-bolder">{productdata.name}</h4>
                ...
                <div className=" justify-content-md-start m-3 ">
                      ...
                      <div class="gap-2 d-md-flex justify-content-md-start border border-dark   " style={{"max-width":"80px"}}>
                        <button className="border border-white bg-white mx-auto p"  onClick={() => handleDecrement(productdata)}>
                          -
                        </button>
