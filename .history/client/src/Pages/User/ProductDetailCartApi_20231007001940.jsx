            ...
            <div className="col-md-8">
              ...
              <h4 className="card-title fw-bolder">{productdata.name}</h4>
                ...
                <div className=" justify-content-md-start m-3 ">
                      ...
                      <div class="gap-2 d-md-flex justify-content-md-start border border-dark p-2   " style={{"max-width":"10px"}}>
                        <button className="border border-white bg-white mx-auto fs-4 "  onClick={() => handleDecrement(productdata)}>
                          -
                        </button>
                        <span>{productdata.quantity}</span>
                        <button className="border border-white bg-white mx-auto"   onClick={() => handleIncrement(productdata)}>
                          +
                        </button>
