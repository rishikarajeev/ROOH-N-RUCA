...
function Products() {
  ...
  const [isFavorite, setIsFavorite] = useState({_id:0,favourite:false,user});
  ...
  const toggleFavorite = (_id) => {
      ...
      if (itemIndex !== -1) {
        ...
        console.log("iiiisFavorite1", favouriteData);
        addtoFavourite();
        }else
        {
          const updatedFavourite = [...productdata];
  ...
  const addtoFavourite = () => {
    ...
    axios.post(FavouriteADDurl, username,name).then((response) => {
