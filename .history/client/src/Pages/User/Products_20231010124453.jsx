...
function Products() {
    ...
    const toggleFavorite = (name) => {
      ...
      {  const updatedObject = {
        ...isFavorite,
        name:namefavourite:true,username:username
        // ... update other keys as needed
      };
         console.log("1..",{name:name,favourite:true,username:username}) 
        setIsFavorite({name:name,favourite:true,username:username})
        addtoFavourite(isFavorite);
      }
      else{
        console.log("2..",{name:name,favourite:true,username:username}) 
        setIsFavorite({name:name,favourite:false,username:username})
        addtoFavourite(isFavorite);
