...
function PruductDetailCartApi() {
  ...
  const handleIncrement = () => {
    setProductata({ ...productdata, quantity: productdata.quantity + 1,subtotal: productdata.quantity+1 * productdata.price });
 };

  const handleDecrement = () => {
    if (productdata.quantity > 0) {
      setProductata({ ...productdata, quantity: productdata.quantity - 1,subtotal: productdata.quantity * productdata.price });
